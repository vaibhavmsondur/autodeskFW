...
import com.crm.autodeskSelenium.objectRepository.ProductPopUpPage;

public class Create_Product_With_MarketingGroup_Test extends BaseClass{
	...
	public void createProductWithMarketingGroup() throws Throwable {
		...
		String handlerDropDownValue = eObj.getDataFromExcel("products", 1, 2);
		...
		//Verify Login Page is Displayed String
